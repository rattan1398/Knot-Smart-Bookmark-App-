    ...
    <div className="min-h-screen flex flex-col bg-white dark:bg-zinc-950 text-gray-900 dark:text-gray-100 transition-colors">
      ...
      <section className="flex-1 flex flex-col items-center justify-center text-center px-4 py-20 sm:py-32 relative overflow-hidden">
        ...
        <p className="max-w-2xl text-lg sm:text-xl text-gray-600 dark:text-gray-400 mb-10 leading-relaxed">
          Knot is your smart, minimalist bookmark manager. Organize your digital
          life with ease, sync across devices, and never lose a link again.
        </p>
      ...
      <section
        id="features"
        className="py-20 px-4 bg-gray-50 dark:bg-zinc-900/50"
      >
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-16">
            Why verify your links with Knot?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-zinc-900 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-zinc-800 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Your bookmarks follow you everywhere. Updates are pushed
                instantly across all your devices via Supabase Realtime.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-zinc-900 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-zinc-800 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Authenticated via Google, your data is yours alone. We
      ...
      {/* Footer */}
      <footer className="bg-gray-50 dark:bg-zinc-950 py-4 border-t border-gray-200 dark:border-zinc-900">
        <div className="max-w-6xl mx-auto px-4 flex justify-between items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-gray-500">
              Knot © {new Date().getFullYear()}
            </span>
          </div>

          <div className="flex gap-8 text-sm text-gray-500">
            <a
              href="mailto:rattankartik708@gmail.com"
